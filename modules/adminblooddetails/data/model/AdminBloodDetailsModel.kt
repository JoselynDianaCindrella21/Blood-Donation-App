package com.kindsapplication.app.modules.adminblooddetails.`data`.model

import com.kindsapplication.app.R
import com.kindsapplication.app.appcomponents.di.MyApp
import kotlin.String

data class AdminBloodDetailsModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtGroupFive: String? = MyApp.getInstance().resources.getString(R.string.lbl_upload)
  ,
  /**
   * TODO Replace with dynamic value
   */
